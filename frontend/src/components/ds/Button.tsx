  ...
  ({ className, variant = 'secondary', size = 'md', icon: Icon, isLoading, block, children, disabled, type = 'button', ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          'inline-flex select-none items-center justify-center gap-2 rounded-xl border font-black transition-[background-color,border-color,color,transform,box-shadow] duration-100 ease-spring active:scale-[0.97] disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-45',
          iconOnly 
